...
export function HackerUIProfileInner() {
  ...
  const initialProjects = [
    { id: 1, title: "IkeOluwa Grills and Chops (WebApp)", desc: "A full-stack resturant platform built for a delivery-only kitchen. Customers can browse small chops, grilled meals and book event packages - all orders are sent via email to the admin", tags: ["Next,js", "React", "TailwindCSS"], url: "https://ikeoluwa-grills.vercel.app", preview: "/projects/ikeoluwa-grills" },
